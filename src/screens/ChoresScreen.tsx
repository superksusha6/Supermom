...
const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    choreCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.surface, borderRadius: 14, borderWidth: 1, borderColor: '#e1e8f2', paddingVertical: 12, paddingHorizontal: 14 },
    check: { width: 28, height: 28, borderRadius: 14, borderWidth: 2, borderColor: '#c7d2e3', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface },
    ...
    modalCard: { maxHeight: '90%', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.96)', backgroundColor: colors.surface, overflow: 'hidden' },
    ...
    toggleBox: { width: 24, height: 24, borderRadius: 7, borderWidth: 2, borderColor: '#c7d2e3', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface },
