...
const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    modalCard: { width: '100%', maxWidth: 440, alignSelf: 'center', maxHeight: '90%', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.96)', backgroundColor: 'rgba(248,250,252,0.98)', overflow: 'hidden' },
