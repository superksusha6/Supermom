...
const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    contactsLink: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: '#e1e8f2', paddingHorizontal: 14, paddingVertical: 11 },
    ...
    issueCard: { backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: '#e1e8f2', padding: 12, gap: 10 },
    ...
    actGhost: { borderWidth: 1, borderColor: '#c7d2e3', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 9, backgroundColor: colors.surface },
    ...
    contactCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.surface, borderRadius: 14, borderWidth: 1, borderColor: '#e1e8f2', paddingVertical: 12, paddingHorizontal: 14, marginTop: 8 },
    ...
    scrim: { flex: 1, backgroundColor: 'rgba(15,23,42,0.45)', justifyContent: 'center', alignItems: 'center', padding: 16 },
    modalCard: { width: '100%', maxWidth: 440, alignSelf: 'center', maxHeight: '90%', borderRadius: 22, borderWidth: 1, borderColor: 'rgba(255,255,255,0.96)', backgroundColor: colors.surface, overflow: 'hidden' },
    ...
    tile: { width: '31.5%', backgroundColor: colors.surface, borderRadius: 14, borderWidth: 1, borderColor: '#e1e8f2', paddingVertical: 14, paddingHorizontal: 6, alignItems: 'center', gap: 6, marginBottom: 10 },
    tileEmoji: { fontSize: 24 },
    tileText: { color: '#14233b', fontSize: 12, fontWeight: '700', textAlign: 'center' },
    pillsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    pickPill: { borderRadius: 999, borderWidth: 1, borderColor: '#d9e4f2', backgroundColor: colors.surface, paddingHorizontal: 14, paddingVertical: 10 },
    ...
    input: { backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: '#d9e4f2', paddingHorizontal: 14, paddingVertical: 12, color: '#14233b', fontSize: 15 },
    inputMultiline: { minHeight: 70, textAlignVertical: 'top' },
    chipsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    chip: { borderRadius: 12, borderWidth: 1, borderColor: '#d9e4f2', backgroundColor: colors.surface, paddingHorizontal: 12, paddingVertical: 8 },
    ...
    modalActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: 10, paddingHorizontal: 18, paddingTop: 12, paddingBottom: 16, borderTopWidth: 1, borderTopColor: '#e1e8f2', backgroundColor: colors.surface },
    ghostBtn: { borderRadius: 14, paddingHorizontal: 18, paddingVertical: 13, borderWidth: 1, borderColor: '#d9e4f2', backgroundColor: colors.surface },
    ghostBtnText: { color: colors.text, fontWeight: '700' },
    secondaryBtn: { borderRadius: 14, paddingHorizontal: 18, paddingVertical: 13, borderWidth: 1, borderColor: colors.primary, backgroundColor: colors.surface },
