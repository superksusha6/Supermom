...
for (const fixture of FIXTURES) {
    const result = (0, recipeNutrition_1.computeRecipeNutrition)(fixture.ingredients, fixture.servings);
    ...
    console.log('computed  kcal ' + c.calories + '  P ' + c.protein + '  F ' + c.fat + '  C ' + c.carbs);
    console.log('stored    kcal ' + s.calories + '  P ' + s.protein + '  F ' + s.fat + '  C ' + s.carbs);
    console.log('delta     kcal ' + calDev + '%  P ' + pct(c.protein, s.protein) + '%  F ' + pct(c.fat, s.fat) + '%  C ' + pct(c.carbs, s.carbs) + '%');
